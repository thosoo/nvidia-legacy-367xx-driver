...
| F. ACPI hierarchy/API | Debian 390xx | legacy 390xx | ACPI compatibility patches | ACPI hierarchy | public helpers in final branch | removes private list usage | method init/uninit shape | stale direct traversal | helper wrappers preserve lifetimes |
...
| F. ACPI hierarchy/API | origin | NVIDIA 470+ / Linux ACPI removals | later NVIDIA ACPI | ACPI hierarchy | `acpi_fetch_acpi_dev`/iterator style helpers | reference-managed | DDC traversal | direct list access | conftest-gated wrappers |
